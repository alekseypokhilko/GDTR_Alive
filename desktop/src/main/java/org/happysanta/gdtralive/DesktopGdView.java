...
import org.happysanta.gdtralive.game.Trainer;
import org.happysanta.gdtralive.game.FrameRender;
...
public class DesktopGdView extends JPanel implements ActionListener, KeyListener {
    ...
    public DesktopGdView() {
        ...
        modManager = new ModManager(fileStorage, new DesktopGdSettings(), new DesktopGdDataSource(), 2.5f);
