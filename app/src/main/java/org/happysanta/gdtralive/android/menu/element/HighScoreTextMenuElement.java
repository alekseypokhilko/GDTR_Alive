...
public class HighScoreTextMenuElement
    ...
    public HighScoreTextMenuElement(String s, int place, boolean layoutPadding) {
        super(s);
        createAllViews();
        setMedal(true, place);
    ...
    public HighScoreTextMenuElement(Spanned text, boolean subtitle) {
        super(text);
        createAllViews();
